...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        // define spacing and cell size, then use var(--cell-size) with bracketed Tailwind arbitrary values
        "[--spacing-8:2rem] [--cell-size:var(--spacing-8)] bg-background group/calendar p-3 [[data-slot=card-content]_&]:bg-transparent [[data-slot=popover-content]_&]:bg-transparent",
      ...
      classNames={{
        ...
        button_previous: cn(
          ...
          // explicit sizing so the nav buttons match the cell size
        ...
        month_caption: cn(
          // use the variable for height and horizontal padding
...
function CalendarDayButton({
  ...
  return (
    <Button
      ...
      className={cn(
        // replaced min-w and removed unsupported `size-` usage
