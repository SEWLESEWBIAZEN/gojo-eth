                ...
                <TableBody>
                  {reservations.map((res) => (
                    <TableRow key={res.id}>
                      ...
                      <TableCell className="text-sm">{res.email}{res.phone_number && <span> | {res.phone_number}</span>}</TableCell>
                      ...
                      <TableCell className="text-right">
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent className="rounded-lg shadow-lg bg-white dark:bg-neutral-800">
                            ...
                            <DropdownMenuItem onClick={() => changeStatus(res.id, 'Received')}>
                              <CheckCircle size={16} className="mr-2" /> Received
                            </DropdownMenuItem>
                            <DropdownMenuItem onClick={() => changeStatus(res.id, 'Cancelled')}>
